...
class AccountRedirectApi {
  ...
  const AccountRedirectApi(this._dio, this._serializers);
  ...
  Future<Response<void>> finishAccountRedirect({ 
    ...
    final _path = r'/api/v1/account-redirect/finish';
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> startAccountRedirect({ 
    ...
    final _path = r'/api/v1/account-redirect/start';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
