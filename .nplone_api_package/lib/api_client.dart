...
class ApiClient {
  ApiClient({this.basePath = 'https://api.nplone.com'}) {
    // Setup authentications (key: authentication name, value: authentication).
    _authentications[r'auth'] = HttpBearerAuth();
  }
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'AccountBalance':
          return AccountBalance.fromJson(value);
        case 'AccountConnectionInitiationDto':
          return AccountConnectionInitiationDto.fromJson(value);
        case 'AccountIdentifiers':
          return AccountIdentifiers.fromJson(value);
        case 'CommentDto':
          return CommentDto.fromJson(value);
        case 'CommentListDto':
          return CommentListDto.fromJson(value);
        case 'CommentPostDto':
          return CommentPostDto.fromJson(value);
        case 'FileDto':
          return FileDto.fromJson(value);
        case 'FileListDto':
          return FileListDto.fromJson(value);
        case 'GoogleToken':
          return GoogleToken.fromJson(value);
        case 'InlineObject':
        ...
        case 'PostDetailsDto':
          return PostDetailsDto.fromJson(value);
        case 'PostEditDto':
          return PostEditDto.fromJson(value);
        case 'PostItemDto':
          return PostItemDto.fromJson(value);
        case 'PostListDto':
          return PostListDto.fromJson(value);
        case 'Provider':
          return Provider.fromJson(value);
        case 'Space':
          return Space.fromJson(value);
        case 'SpaceBankingInfo':
          return SpaceBankingInfo.fromJson(value);
        case 'SpaceCreate':
          return SpaceCreate.fromJson(value);
        case 'SpaceEdit':
          return SpaceEdit.fromJson(value);
        case 'SpaceItem':
        ...
        case 'TransactionAccountDetails':
          return TransactionAccountDetails.fromJson(value);
        case 'TransactionDetailsDto':
          return TransactionDetailsDto.fromJson(value);
        case 'TransactionEditDto':
          return TransactionEditDto.fromJson(value);
        case 'TransactionItemDto':
          return TransactionItemDto.fromJson(value);
        case 'TransactionListDto':
          return TransactionListDto.fromJson(value);
        case 'TransactionViewConfiguration':
          return TransactionViewConfiguration.fromJson(value);
        case 'UserInfo':
          return UserInfo.fromJson(value);
        case 'UserLogin':
          return UserLogin.fromJson(value);
        case 'UserRegister':
          return UserRegister.fromJson(value);
        case 'UserSummaryDto':
          return UserSummaryDto.fromJson(value);
        default:
          Match match;
