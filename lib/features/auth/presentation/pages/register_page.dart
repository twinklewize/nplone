            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyTextField(
                          ...
                          fillColor: AppColors.gray1,
                          labelText:
                              S.of(context).signinPagePasswordTextFieldHintText,
                          maxLines: 1,
                          minLines: 1,
                          keyboardType: TextInputType.emailAddress,
                          inputTextColor: Colors.white,
                        ...
                        Text(
                          S.of(context).signinPageRepeatPasswordTextFieldTitle,
                          style: AppTextStyles.regular16pt,
                        ),
                        SizedBox(height: 4),
                        ...
                        MyTextField(
                          ...
                          autocorrect: false,
                          obscureText: true,
                          validationFunction: repeatPasswordValidation(context),
                  ...
                  RichText(
                    text: new TextSpan(
                      text: S.of(context).signinPageByPressingSignInYouAgreeTo,
                      style: AppTextStyles.regular16pt,
                      children: [
                        new TextSpan(
